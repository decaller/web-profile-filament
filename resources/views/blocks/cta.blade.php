<section class="py-24 relative overflow-hidden bg-primary text-primary-content">
    ...
    <div class="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-white/10 to-transparent transform -skew-x-12 translate-x-1/4"></div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        @if(!empty($data['text']))
            <p class="text-xl opacity-80 mb-10 max-w-2xl mx-auto font-light">
                {{ $data['text'] }}
            </p>
        @endif
        
        <a href="{{ $data['button_url'] ?? '#' }}" class="btn btn-lg bg-base-100 hover:bg-base-200 text-primary border-none shadow-[0_0_30px_rgba(255,255,255,0.2)]">
