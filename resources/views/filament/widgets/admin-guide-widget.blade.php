<x-filament-widgets::widget>
    <x-filament::section>
        <div class="flex flex-col gap-8 p-6 sm:gap-10 sm:p-8 md:gap-12 md:p-10 lg:p-12">
            ...
            <div class="relative overflow-hidden p-4 shadow-xl dark:shadow-none">
                <div class="relative z-10">
                    ...
                    <p class="mt-4 max-w-2xl text-lg font-medium leading-relaxed text-slate-500 dark:text-slate-400">
                        Ikuti panduan cepat di bawah ini untuk mengelola website sekolah Anda secara efisien dan terstruktur.
                    </p>
                </div>
            ...
            <div class="group relative border border-slate-200 p-8 shadow-sm transition-all hover:border-primary-300 hover:shadow-md dark:border-slate-700 dark:hover:border-primary-500 sm:p-10 md:p-12">
                <div class="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-12">
                    <div class="flex items-center gap-5 lg:w-1/4">
                        <div class="flex h-14 w-14 shrink-0 items-center justify-center text-primary-600 dark:text-primary-400">
                    ...
                    <div class="grid flex-1 grid-cols-1 gap-8 sm:grid-cols-2">
                        <div class="flex gap-5">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center text-base font-bold text-slate-600 dark:text-slate-300">1</span>
                            <div>
                                <h4 class="text-lg font-bold text-slate-900 dark:text-white">Kelola Pages</h4>
                                <p class="mt-2 text-sm leading-relaxed text-slate-500 dark:text-slate-400">Gunakan tab <strong class="dark:text-slate-200">Pages</strong> untuk mengedit konten utama profil sekolah.</p>
                            </div>
                        </div>
                        <div class="flex gap-5">
                            <span class="flex h-10 w-10 shrink-0 items-center justify-center text-base font-bold text-slate-600 dark:text-slate-300">2</span>
                            <div>
                                <h4 class="text-lg font-bold text-slate-900 dark:text-white">Atur Menu</h4>
                                <p class="mt-2 text-sm leading-relaxed text-slate-500 dark:text-slate-400">Sambungkan halaman ke navigasi di <strong class="dark:text-slate-200">Settings -> Menus</strong>.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="group relative border border-slate-200 p-8 shadow-sm transition-all hover:border-primary-300 hover:shadow-md dark:border-slate-700 dark:hover:border-primary-500 sm:p-10 md:p-12">
                <div class="flex flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
                    <div class="flex items-center gap-5 lg:w-1/4">
                        <div class="flex h-14 w-14 shrink-0 items-center justify-center text-orange-600 dark:text-orange-400">
            ...
            <div class="flex flex-col gap-8 lg:flex-row lg:gap-10">
                ...
                <div class="p-8 shadow-xl dark:border dark:border-slate-700 sm:p-10 md:p-12 lg:w-1/3">
                    ...
                    <div class="border-t border-slate-800 pt-6 dark:border-slate-700">
                        <span class="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400">Sistem Profil Sekolah v1.0</span>
                    </div>
                </div>
            </div>
        </div>
